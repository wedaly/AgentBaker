...
$global:NextGenNetworkingUrlBase = "{{GetVariable "windowsNextGenNetworkingUrlBase"}}"
...
try
{
    ...
    Start-InstallWindowsNextGenNetworkingIfNeeded -EnableInstall $global:EnableNextGenNetworking $global:NextGenNetworkingUrlBase
